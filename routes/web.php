...
Route::middleware(['auth', 'status'])->group(function () {
    ...
    Route::middleware(['auth', 'user'])->group(function () {
        Route::get('/user-dashboard', [RootDashboardController::class, 'userDashboard'])->name('user.dashboard');
    });
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        // Info block Routes
        Route::get('/info-block',           [InfoBlockController::class, 'index'])->name('admin.info-block.index');
        ...
        Route::post('/booking/delete/{id}',   [BookingController::class, 'destroy'])->name('admin.booking.delete');
