    ...
    <div class="stepnow-cb__inner" role="document">
        ...
        <p id="stepnow-cookie-text" class="stepnow-cb__text">
            <?php if($isEN): ?>
                ...
                "<?php echo e(__('Cookie Settings')); ?>" link in the footer. Details in our
                <a href="<?php echo e(lroute('front.datenschutz')); ?>"><?php echo e(__('Privacy Policy')); ?></a>
                and
                <a href="<?php echo e(lroute('front.impressum')); ?>"><?php echo e(__('Imprint')); ?></a>.
            <?php else: ?>
                ...
                „<?php echo e(__('Cookie Settings')); ?>" im Footer ändern oder widerrufen.
        ...
        <div class="stepnow-cb__categories" id="stepnow-cb-categories" hidden>
            ...
            <label class="stepnow-cb__row">
                ...
                <span>
                    <strong><?php echo e(__('Necessary')); ?></strong>
                    <?php if($isEN): ?>
            ...
            <label class="stepnow-cb__row">
                ...
                <span>
                    <strong><?php echo e(__('Statistics')); ?></strong>
                    <?php if($isEN): ?>
            ...
            <label class="stepnow-cb__row">
                ...
                <span>
                    <strong><?php echo e(__('Marketing')); ?></strong>
                    <?php if($isEN): ?>
...
<?php /**PATH D:\laragon\www\Step-Now\resources\views/front/partials/legal/cookie-consent.blade.php ENDPATH**/ ?>