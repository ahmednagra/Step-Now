...
<section class="faq-two" aria-labelledby="faq-heading">
    ...
    <div class="container">
        ...
        <div class="section-title text-center sec-title-animation animation-style1 mb-4">
            <?php if($sectionSub): ?>
                <div class="section-title__tagline-box justify-content-center">
                    <span class="section-title__tagline"><?php echo e($sectionSub); ?></span>
                </div>
            <?php endif; ?>
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8 col-lg-6">
                <label for="snFaqSearch" class="visually-hidden">
                    <?php echo e($isEN ? 'Search FAQs' : 'FAQ durchsuchen'); ?>
                ...
                <div style="position:relative;">
                    ...
                    <input type="search"
                           id="snFaqSearch"
                           class="sn-input"
                           placeholder="<?php echo e($isEN ? 'Type to filter questions…' : 'Tippen, um Fragen zu filtern …'); ?>"
                           autocomplete="off"
        ...
        <div class="faq-two__inner-content">
            <div class="sn-faq-list" data-sn-faq-list>
                ...
                <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <details id="<?php echo e($hash); ?>"
                             class="sn-faq-item wow fadeInUp"
                             data-wow-delay="<?php echo e(($index % 5) * 80); ?>ms"
                             data-sn-faq-item
                             data-sn-q="<?php echo e(Str::lower($question . ' ' . strip_tags($answer))); ?>"
                             <?php echo e($isFirst ? 'open' : ''); ?>>

                        <summary class="sn-faq-question">
                            <span class="sn-faq-q-text"><?php echo e($question); ?></span>
        ...
        <p class="text-center mt-5 sn-prose mx-auto">
            <?php echo e($isEN ? 'Question not answered?' : 'Frage nicht beantwortet?'); ?>

            <a href="<?php echo e(lroute('front.contactus')); ?>" style="text-decoration:underline;">
                <?php echo e($isEN ? 'Contact us directly' : 'Kontaktieren Sie uns direkt'); ?>
