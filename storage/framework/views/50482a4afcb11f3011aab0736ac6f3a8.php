    ...
    <div class="container">
        ...
        <div class="section-title text-center sec-title-animation animation-style1 mb-5">
            <div class="section-title__tagline-box justify-content-center">
                <span class="section-title__tagline"><?php echo e($isEN ? 'What we offer' : 'Was wir bieten'); ?></span>
            </div>
            <h2 id="services-heading" class="section-title__title title-animation">
                <?php echo e($isEN ? 'Reliable transport services in your region' : 'Zuverlässige Transportleistungen in Ihrer Region'); ?>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 wow fadeInUp"
                     data-wow-delay="<?php echo e(($loop->index % 4) * 100); ?>ms"
                     data-wow-duration="1500ms">

                    <article class="services-one__single sn-service-card" aria-labelledby="<?php echo e($cardId); ?>">
                        ...
                        <h3 id="<?php echo e($cardId); ?>" class="services-one__title">
                            <a href="<?php echo e($detailUrl); ?>" class="stretched-link">
                        ...
                        <p class="services-one__text sn-line-clamp-3">
                            <?php echo e($serviceDesc); ?>

                        </p>

                        <span class="services-one__cta sn-service-cta" aria-hidden="true">
                            <?php echo e($isEN ? 'Learn more' : 'Mehr erfahren'); ?>
