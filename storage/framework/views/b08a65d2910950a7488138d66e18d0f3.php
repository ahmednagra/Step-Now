    ...
    <div class="container">
        <div class="section-title text-center sec-title-animation animation-style2">
            <div class="section-title__tagline-box justify-content-center">
                <span class="section-title__tagline"><?php echo e(__('Process')); ?></span>
            </div>
            <h2 class="section-title__title title-animation"><?php echo e(__('Car Rental Process')); ?></h2>
        </div>
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                <div class="process-one__single">
                    <div class="process-one__single-bg"
                        style="background-image: url(<?php echo e(asset('front')); ?>/assets/images/Listing-pic1.jpg);">
                    </div>
                    ...
                    <h3 class="process-one__title"><?php echo e(__('Choose Vehicle')); ?></h3>
                    <p class="process-one__text">
                        <?php echo e(__('Select the right vehicle from our diverse range')); ?>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div class="process-one__single">
                    ...
                    <h3 class="process-one__title"><?php echo e(__('Get in Touch')); ?></h3>
                    <p class="process-one__text">
                        <?php echo e(__('Contact us for advice, reservation or further information')); ?>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
                <div class="process-one__single">
                    ...
                    <h3 class="process-one__title"><?php echo e(__('Choose Pickup Location')); ?></h3>
                    <p class="process-one__text">
                        <?php echo e(__('Select the pickup location that suits you best')); ?>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="700ms" data-wow-duration="1500ms">
                <div class="process-one__single">
                    ...
                    <h3 class="process-one__title"><?php echo e(__('Enjoy the Ride')); ?></h3>
                    <p class="process-one__text">
                        <?php echo e(__('Get in and enjoy a comfortable and safe journey')); ?>
