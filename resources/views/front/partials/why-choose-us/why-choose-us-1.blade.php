    ...
    <div class="container">
        <div class="section-title text-center sec-title-animation animation-style2">
            <div class="section-title__tagline-box justify-content-center">
                ...
                <span class="section-title__tagline">{{ tr($why_choose_us, 'subtitle') }}</span>
            </div>
            <h2 class="section-title__title title-animation">{{ tr($why_choose_us, 'title') }}</h2>
        </div>
        <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow {{ $animationClass }}" data-wow-delay="{{ $delay }}" data-wow-duration="1500ms">
                    <div class="why-choose-one__single">
                        <div class="why-choose-one__icon">
                            <img src="{{ asset($detail->icon) }}" alt="{{ tr($detail, 'title') }}" width="50px">
                        </div>
                        <div class="why-choose-one__single-inner">
                            <h3 class="why-choose-one__title">{{ tr($detail, 'title') }}</h3>
                            <p class="why-choose-one__text">
                                {{ tr($detail, 'description') }}
                            </p>
                        </div>
                        <div class="why-choose-one__btn-box">
                            <a href="{{ route('front.contactus') }}" class="thm-btn">
                                {{ __('Get Quote') }}<span class="fas fa-arrow-right"></span>
                            </a>
                        </div>
                    </div>
                </div>
