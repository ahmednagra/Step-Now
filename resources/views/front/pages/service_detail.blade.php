        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 text-center">
                    <div class="p-4 border rounded">
                        ...
                        @endif
                        <h5 class="fw-bold mb-3">{{ __('Category Details') }}</h5>
                        <p><strong>{{ __('Category') }}:</strong> {{ $service->serviceCategory->title }}</p>
            ...
            <div class="row mt-60">
                <div class="col-12 mb-4">
                    <h2 class="section-title__title title-animation mt-5">{{ __('Related Services') }}</h2>
                </div>
                ...
                @empty
                    <p class="text-center">{{ __('No related services') }}</p>
                @endforelse
