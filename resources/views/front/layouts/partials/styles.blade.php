{{--
    ...
    Compliance changes (kept from previous version):
      - Google Fonts (fonts.googleapis.com / fonts.gstatic.com) replaced
        ...
        Analytics integration. This avoids the LG München I ruling
        (Az. 3 O 17493/20) on dynamic Google Fonts embedding.
...
<link
    href="https://fonts.bunny.net/css?family=roboto:100,300,400,500,700,900&family=inter-tight:100,200,300,400,500,600,700,800,900&display=swap"
    rel="stylesheet">

{{-- Locally-hosted versions of formerly-CDN icon fonts --}}
