...
{{-- Wave 5: removed broken `public/` prefix; was always 404'ing on first try --}}
<link rel="stylesheet" href="{{ asset('front/assets/css/custom-tokens.css') }}">
...
{{-- 9. Per-page CSS overrides --}}
@yield('css')

{{-- 10. Responsive media-query layer --}}
<link rel="stylesheet" href="{{ asset('front/assets/css/responsive.css') }}">

{{-- 11. Brand polish — loaded LAST so it can override theme defaults --}}
