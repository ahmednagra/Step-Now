                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="phone_no" class="form-control form-control-sm"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <textarea id="enquiry_message" class="form-control form-control-sm form-control form-control-sm-sm"
                                                name="enquiry_message" rows="4" placeholder="{{ __('Enter Enquiry Message') }}">{{ old('enquiry_message') }}</textarea>
                                        </div>
