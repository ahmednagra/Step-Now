...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ __('Edit Booking') }} </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i>{{ __('Home') }}</a>
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Edit Booking') }}</h3>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.booking.update', $booking->id) }}"
                                method="post">
                                @csrf

                                {{-- Full Name --}}
                                <div class="form-group row">
                                    <label for="full_name" class="col-sm-12 control-label">{{ __('Full Name') }} <span
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="full_name" class="form-control form-control-sm"
                                                name="full_name" value="{{ old('full_name', $booking->full_name) }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <input type="email" id="email" class="form-control form-control-sm"
                                                name="email" value="{{ old('email', $booking->email) }}"
                                ...
                                {{-- Offer ID --}}
                                <div class="form-group row">
                                    <label for="offer_id" class="col-sm-12 control-label">{{ __('Offer ID') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="number" id="offer_id" class="form-control form-control-sm"
                                                name="offer_id" value="{{ old('offer_id', $booking->offer_id) }}"
                                ...
                                {{-- Pickup --}}
                                <div class="form-group row">
                                    <label for="pickup" class="col-sm-12 control-label">{{ __('Pickup') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" id="pickup" class="form-control form-control-sm"
                                                name="pickup" value="{{ old('pickup', $booking->pickup) }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="destination" class="form-control form-control-sm"
                                                name="destination" value="{{ old('destination', $booking->destination) }}"
                                ...
                                {{-- Booking Date --}}
                                <div class="form-group row">
                                    <label for="booking_date" class="col-sm-12 control-label">{{ __('Booking Date') }}
                                ...
                                {{-- Booking Time --}}
                                <div class="form-group row">
                                    <label for="booking_time" class="col-sm-12 control-label">{{ __('Booking Time') }}
                                        <span class="text-danger">*</span></label>
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                ...
                                {{-- No. of People --}}
                                <div class="form-group row">
                                    <label for="no_of_people" class="col-sm-12 control-label">{{ __('No. of People') }}
                                        <span class="text-danger">*</span></label>
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <textarea id="message" class="form-control form-control-sm" name="message" rows="4"
                                                placeholder="{{ __('Enter Message') }}">{{ old('message', $booking->message) }}</textarea>
                                        </div>
                                        @error('message')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="status" name="status" class="form-control form-control-sm">
                                                <option value="" disabled
                                                    {{ old('status', $booking->status) == '' ? 'selected' : '' }}>Select
                                                    Status</option>
                                                <option value="pending"
                                                    {{ old('status', $booking->status) == 'pending' ? 'selected' : '' }}>
                                                    Pending</option>
                                                <option value="inprocess"
                                                    {{ old('status', $booking->status) == 'inprocess' ? 'selected' : '' }}>
                                                    In Process</option>
                                ...
                                <div class="form-group row">
                                    <label for="admin_remarks"
                                        class="col-sm-12 control-label">{{ __('Admin Remarks') }}</label>
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <textarea id="admin_remarks" class="form-control form-control-sm" name="admin_remarks" rows="3"
                                                placeholder="{{ __('Enter Admin Remarks') }}">{{ old('admin_remarks', $booking->admin_remarks) }}</textarea>
                                        </div>
                                        @error('admin_remarks')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
